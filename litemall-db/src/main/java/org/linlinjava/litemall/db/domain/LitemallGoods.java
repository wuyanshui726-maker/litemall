...
public class LitemallGoods {
    ...
    public enum Column {
        ...
        shelfLifeDays("shelf_life_days", "shelfLifeDays", "INTEGER", false),
        expireDate("expire_date", "expireDate", "DATE", false),
        lowStockThreshold("low_stock_threshold", "lowStockThreshold", "INTEGER", false);
